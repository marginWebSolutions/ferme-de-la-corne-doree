...
export default function Meta() {
    ...
    return (
        <>
            <Helmet>
                <meta name="description" content="La Ferme de la corne dorée est une chèvrerie unique dans les monts du Lyonnais : Dégustez nos fromages de chèvre artisanaux et initiez-vous à l'équitation Western." />
                ...
                <meta name="twitter:image" content="%PUBLIC_URL%/img/logo_de_la_ferme_de_la_corne_doree.jpg" />
                ...
                <meta property="og:image" content="%PUBLIC_URL%/img/logo_de_la_ferme_de_la_corne_doree.jpg" />
            </Helmet>
        </>
    );
}